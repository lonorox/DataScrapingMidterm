...
class Analyzer:
    def frequent_tags(self,file):
        ...
        for tags in df_quotes['tags']:
            ...
            # Split and add to the all_tags list, handling cases where tags might be empty or malformed
            if tags:  # Ensure the tag is not empty
                all_tags.extend(str(tags).split(", "))  # Split and add to the list
            else:
        ...
        plot_filename = "data/most_frequent_tags.png"
